...
def parse_args():
    ...
    parser.add_argument(
    '--forget_file', type=str, default=None,
    help='Path to a txt file with one node-ID per line; overrides --df_size sampling'
    )
    
    # Model
    #parser.add_argument('--mode', choices=['node','edge'], default='node')
